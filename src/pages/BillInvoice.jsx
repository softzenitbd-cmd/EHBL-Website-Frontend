...
const BillInvoice = () => {
  const { inventory, staff, user, customers, addCustomer, processSale, sales, showToast, drafts, saveDraft, deleteDraft, deleteSale } = useStore();
  ...
  const handleSaveDraft = async () => {
    ...
    if (!result.success) {
      showToast(`Draft was not saved: ${result.error}`, 'error');
      return;
    }
