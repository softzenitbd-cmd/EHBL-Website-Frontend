...
const Expenses = () => {
  const { expenses, addExpense, expenseCategories, addExpenseCategory, showToast } = useStore();
  ...
  const handleCreateCategory = async () => {
    ...
    if (!result.success) {
      showToast(`Category was not created: ${result.error}`, 'error');
      return;
    }
  ...
  const handleAddExpense = async (e) => {
    ...
    if (!result.success) {
      showToast(`Expense was not saved: ${result.error}`, 'error');
      return;
    }
