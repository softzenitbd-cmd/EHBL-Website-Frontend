...
const Settings = () => {
  ...
  const handleSaveProfile = async (e) => {
    ...
    if (!profileForm?.shop_name?.trim()) {
      showToast('Shop name cannot be empty - it prints at the top of every invoice.', 'error');
      return;
    }
    ...
    if (!result.success) {
      showToast(`Shop profile was not saved: ${result.error}`, 'error');
      return;
    }
    setProfileSaved(true);
    showToast('Shop profile saved. New invoices will print this.', 'success');
  };
